...
export default function DocumentChecklistMovedPage() {
  return (
    <div className="space-y-12 flex flex-col items-center justify-center min-h-[calc(100vh-20rem)] py-8">
      <SectionTitle
        title="Feature Moved"
        subtitle="The Document Checklist generator has been integrated into our Smart Tools page."
      />
      <Card className="max-w-lg w-full text-center shadow-xl bg-card">
        ...
        <CardContent>
          <p className="text-foreground/80 mb-6">
            ...
            You can find the latest version, now using efficient predefined checklists, on our "Smart Tools" page.
          </p>
